...
# npx hardhat flatten ./contracts/oracle/PairOracle.sol 2>&1 | tee ./flattens/PairOracle_flatten.sol
...
# npx hardhat flatten ./contracts/IvoryVoteCount.sol 2>&1 | tee ./flattens/IvoryVoteCount_flatten.sol
